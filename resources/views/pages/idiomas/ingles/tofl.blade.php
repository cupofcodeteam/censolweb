...
<div id="toefl">
  ...
  <section class="informacion-1" class="">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"> TOFL</li>
    </ol>
    <div class="container">
      <div class="row padding-bottom">

        <div class="col-md-6 texto-pequeño">
          <p>Aprende en un entorno 100% en ingles, donde contaras con dvds y cds de videos, audios y textos para facilitar el aprendizaje continuo y el exito de la prueba a presentar. El material a utilizar será <strong>la Editorial oficial de la PRUEBA TOEFL ETS, compilado por McGRAW HILL, 4TA Edición, New York, USA, 2011.</strong><br>
          </p>
        </div>
        <div class="col-md-6 appear-right">
          <img class="img-responsive toelfimg" src="/images/home/toefl.png">
      ...
      <div class="row">
        ...
        <div class="col-md-4 text-center appear-right">
          ...
          <h2>Metodología</h2>
          <p>THE OFFICIAL GUIDE TO THE TOEFL TEST</p>
