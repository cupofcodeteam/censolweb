...
<div id="Arabe">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"> Árabe</li>
  </ol>
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <p><img class="" src="/images/ingles/calendario-p.png"> Por Definir </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div id="image-wrapper">
              <div class="image-1">
                <img class="img-responsive" src="/images/idiomas/arabic.jpg" alt="" />
              </div>
              <div class="image-2">
                <img class="img-responsive" src="/images/home/idiomas/i22.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
