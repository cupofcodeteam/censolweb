...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active"> Francés</li>
</ol>
...
<div id="projects-details" class="padding-top">
  ...
  <div class="informacion-4">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <h2>Programa De Francés</h2>
          <p>Aprende esta asombroso idioma con los mejores profesores de la zona, contamos con los libros del profesor, libro del estudiante, libro de ejercicios, cd de audio, de la <strong>la Editorial CLE INTERNATIONAL, de Maïa Grégoire, 3RA EDICION </strong>. Paris, Francia, 2004.

          </p>

          <div class="row">
            <div class="col-md-6">
              <p><img class="" src="/images/ingles/reloj-circular-p.png">  sábados de 8:30 a 12:00ama </p>
            </div>
            <div class="col-md-6">
              <p><img class="" src="/images/ingles/calendario-p.png">  5 meses (20 sábados) en curso personalizado o en grupo.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div id="image-wrapper">
            <div class="image-1">
              <img class="img-responsive" src="/images/idiomas/france.jpg" alt="" />
            </div>
            <div class="image-2">
              <img class="img-responsive" src="/images/home/idiomas/i33.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
