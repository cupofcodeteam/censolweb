...
@section('content')
  ...
  <div id="madarin">
    ...
    <div id="" class="padding-top">
      <div class="informacion-4">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <h2>Programa de Mandarin</h2>
              <p>Aprende esta asombroso idioma con los mejores profesores de la zona, contamos con los libros del profesor, libro del estudiante, libro de ejercicios, cd de audio, de la <strong>de la Editorial de la OFICINA NACIONAL DE ENSEÑANZA DEL CHINO COMO LENGUA EXTRANJERA DE CHINA,</strong> compilado por el Prof. Dr. Juan José Ciruela Alférez, en la UNIVERSIDAD DE GRANADA, Madrid, España, 2010. Este programa consta de <strong> 5 niveles </strong>
            ...
            <div class="col-sm-6">
              <div id="image-wrapper">
                <div class="image-1">
                  <img class="img-responsive" src="/images/idiomas/chinese.jpg" alt="" />
                </div>
                <div class="image-2">
                  <img class="img-responsive" src="/images/home/idiomas/i77.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
